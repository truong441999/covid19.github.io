...
<body>
    ...
    <h1 class="text-danger">Cập nhật lại thông tin cá nhân</h1>
    <form action="/FinalProject/UpdateThongTinServlet" method="POST" id="demoForm"class="my-2 my-lg-0">
	     <label>Số điện thoại <span class="text-danger">(*)</span></label>
	       <input type="tel" name="Phone" readonly value="<%out.print(adm.getUserPhone());%>"  class="form-control   ml-sm-2  sss"><br>
	      <label>Họ và tên <span class="text-danger">(*)</span></label>
         <input type="text" name="name" value="<%out.print(adm.getUserName());%>"  class="form-control  ml-sm-2  sss"><br>
         ...
         <input type="date" name="ngaysinh" value="<%out.print(adm.getUserNgaySinh());%>" class="form-control  ml-sm-2  sss"><br>
        ...
        <select class="form-control" id="huyen" name="huyen"  onchange="genderChanged(this)">
          <option selected><%out.print(adm.getUserHuyen()); %></option>
        ...
        <select class="form-control" id="xa" name="xa">
          <option selected><%out.print(adm.getUserXa()); %></option>
        </select>
        <label>Địa chỉ nhà <span class="text-danger">(*)</span></label>
         <input type="text" name="diachi" value="<%out.print(adm.getUserDiaChi()); %>" placeholder="Địa chỉ nhà"  class="form-control  ml-sm-2  sss"><br>
       <label>Trạng thái <span class="text-danger">(*)</span></label>
         <input type="text" readonly name="trangthai" value="<%out.print(adm.getUserTrangThai()); %>" placeholder="Địa chỉ nhà"  class="form-control  ml-sm-2  sss"><br>
