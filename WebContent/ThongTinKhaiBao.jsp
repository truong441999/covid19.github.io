...
<body>
 ...
 <li class="nav-item">
   ...
   <div class="container noidung">
        ...
        <h1><i class="far fa-newspaper"></i> Quản lý sức khỏe</h1></div>
        <div class="container mt-3">
          <h2>Danh sách người khai báo</h2>
          <h6><a href="DanhSachNhiemBenh.jsp">Danh sách nhiễm Covid-19</a></h6>
             ...
             %>
              <tr>
                ...
                <td><%out.write(s.getUserGioiTinh()); %></td>
                 ...
                 <td><%out.write(s.getUserTrangThai()); %></td>
                <% out.write("<td> <a class='btn btn-danger' href=addListNhiemBenhServlet?ID="+s.getUserPhone()+">"+"  <input class='btn btn-danger' type=submit value=Add />"+ "</td>"); %>
                 <% out.write("<td> <a class='btn btn-success' href=viewUserServlet?ID="+s.getUserPhone()+">"+"  <input class='btn btn-success' type=submit value=View />"+ "</td>"); %>
              </tr>
             <% }%>
            </tbody>
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel"><i class="fas fa-history"></i> Lịch sử theo dõi sức khỏe</h5>
                ...
                <div class="modal-body">
                  ...
                  <p>Họ và tên: Phan Văn Khải</p>
                  <p>Số điện thoại : 0344624700</p>
                  </div>
                  <div class="ovr">
                    <div class="history">
                      <div class="historyEvr">
                        <label for=""><i class="fas fa-clock"></i> 04/08/2020</label>
                    ...
                    <div class="history">
                      <div class="historyEvr">
                        ...
                        <p><span class="font-weight-bold">Thông tin sức khỏe:</span> Mắc bệnh</p>
                      </div>
