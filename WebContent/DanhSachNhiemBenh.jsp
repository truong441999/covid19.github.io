...
<head>
    ...
    <title>Danh Sách Nhiễm Bệnh</title>
    <link rel = "icon" href =  
 ...
 <li class="nav-item">
   ...
   <div class="container noidung">
        ...
        <div class="container mt-3">
          <h2>Danh sách người nhiễm covid-19</h2>
          <h6><a href="ThongTinKhaiBao.jsp">Danh sách Khai Báo</a></h6>
          ...
          <table class="table table-bordered">
            ...
            for(user s: users){
            	if(s.getUserTrangThai().equals("Nhiễm bệnh")){
             ...
             %>
              <tr>
                ...
                <td><%out.write(s.getUserGioiTinh()); %></td>
                 ...
                 <% out.write("<td> <a class='btn btn-success' href=viewF1Servlet?ID="+s.getUserPhone()+">"+"  <input class='btn btn-success' type=submit value=View />"+ "</td>"); %>
              </tr>
             <% }}%>
            </tbody>
